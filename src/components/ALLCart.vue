  ...
  <div id="brall">
    <div id="middle">
      ...
      <table class="table table-bordered table-striped" style="text-align: center;">
        <tr>
          <th colspan="7" style="text-align: center;">购物车信息</th>
        </tr>
        <tr>
...
export default {
  ...
  created() {
    ...
    axios.get("http://localhost:8080/api/goods/admin/all/cart/1",{}).then(
        response => {
  ...
  methods: {
    ...
    'turnToPrePage'() {
      axios.get(`http://localhost:8080/api/goods/admin/all/cart/${this.page.prePage}`, {}).then(
          response => {
            console.log(response.data)
            if (response.data.code == "1") {
              this.page = response.data.page
    ...
    'turnToNext'() {
      axios.get(`http://localhost:8080/api/goods/admin/all/cart/${this.page.nextPage}`, {}).then(
          response => {
            console.log(response.data)
            if (response.data.code == "1") {
              this.page = response.data.page
    ...
    'turnToLast'() {
      axios.get(`http://localhost:8080/api/goods/admin/all/cart/${this.page.pages}`, {}).then(
          response => {
            console.log(response.data)
            if (response.data.code == "1") {
              this.page = response.data.page
