...
export default {
  ...
  created() {
    axios.get("http://localhost:8080/api/goods/admin/all/indent/1",{}).then(
        response => {
  ...
  methods: {
    ...
    'turnToPrePage'() {
      axios.get(`http://localhost:8080/api/goods/admin/add/indent/${this.page.prePage}`, {}).then(
          response => {
            console.log(response.data)
            if (response.data.code == "1") {
              this.page = response.data.page
    ...
    'turnToNext'() {
      axios.get(`http://localhost:8080/api/goods/admin/all/indent/${this.page.nextPage}`, {}).then(
          response => {
            console.log(response.data)
            if (response.data.code == "1") {
              this.page = response.data.page
    ...
    'turnToLast'() {
      axios.get(`http://localhost:8080/api/goods/admin/all/indent/${this.page.pages}`, {}).then(
          response => {
            console.log(response.data)
            if (response.data.code == "1") {
              this.page = response.data.page
